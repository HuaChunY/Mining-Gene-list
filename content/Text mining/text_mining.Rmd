...
![PubTator central](/images/PubTator central.jpg?width=90pc)
...
![BioGraph](/images/BioGraph.jpg?width=90pc)
...
![iPTMnet](/images/iPTMent.jpg?width=100pc)
  
- **Installation**: 1.Start R (version "4.2") and enter:
```{r}
Installation: install.packages("iptmnetr")
```
 2.Python package:
```{python}
...
![iPTMnet1](/images/iPTMnet2.jpg?width=90pc)
